...
namespace ManyWho.Flow.SDK
{
    public class ManyWhoConstants
    {
        ...
        /// <summary>
        /// A date value. Using the REST API, the value should be provided in ISO 8601 format.
        /// </summary>
        public const string CONTENT_TYPE_DATE = "ContentDate";
        
        /// <summary>
        /// A time value. Using the REST API, the value should be provided in ISO 8601 format.
        /// </summary>
